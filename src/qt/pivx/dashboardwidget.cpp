    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of XMD earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 XMD");
...
void DashboardWidget::loadWalletModel()
{
 ...
 ///       connect(ui->btnHowTo, &QPushButton::clicked, window);
    ...
    // update the display unit, to not use the default ("XMD")
    updateDisplayUnit();
}
