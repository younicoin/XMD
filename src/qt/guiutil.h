...
/** Utility functions used by the Mandike Qt UI.
 */
namespace GUIUtil
{
...
// Render XMD addresses in monospace font
...
// Parse "mandike:" URI into recipient object, return true on successful parsing
