...
/* Mandike GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Mandike"
#define QAPP_ORG_DOMAIN "mandike.io"
#define QAPP_APP_NAME_DEFAULT "Mandike-Qt"
#define QAPP_APP_NAME_TESTNET "Mandike-Qt-testnet"
