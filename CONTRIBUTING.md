Contributing to Mandike Core
============================

The Mandike Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/MandikeBF/Mandike/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Mandike Core project, and is not to be
confused with overall Mandike Network Protocol consensus changes.

Whether a pull request is merged into Mandike Core rests with the project merge
...
Patches that change Mandike consensus rules are considerably more involved than
...
Where a patchset proposes to change the Mandike consensus, it must have been
...
The project leader is the release manager for each Mandike Core release.
