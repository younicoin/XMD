...
OutputDir=.\output
OutputBaseFilename=MandikeSetup
...
[Files]
Source: ".\package\mandike-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Mandike\Mandike-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Mandike\Mandike-Qt,strDataDir|{userappdata}\Mandike\}');
  Result := True;
end;
