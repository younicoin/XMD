...
* Fill in the following data:
    * Application Name: `Mandike Core`
    * Application Version: `2.0.0.0`
    * Application Publisher: `2024 Mandike Core Developers`
    * Application Website: `https://mandike.io/`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `Mandike`
* Add application files:
    * Select the file `mandike-qt.exe` as main executable from the `package` folder
...
* Compiler settings
    ...
    * Edit the output base filename to: `mandike-1.1.0-win64-setup.exe`
