...
"""Verify that starting mandike with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mandike with -? for help text")
        ...
        self.log.info("Start mandike with -version for version information")
