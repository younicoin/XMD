...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected XMD supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check XMD supply at the beginning
        # ------------------------------------------
        ...
        # Verify that XMD supplies were properly updated after the spends and reorgs
        self.log.info("Check XMD supply...")
